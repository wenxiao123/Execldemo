...
// 定义编码方式，为了支持中文，这里使用了ENCODING_UTF_16
                ...
                switch (colNum){
                    case 0:
                        ...
                        break;
                    case 1:
                        cell.setCellValue("CJ1");
                        break;
                    case 2:
                        cell.setCellValue("CJ2");
                        break;
                    case 3:
                        cell.setCellValue("CJ3");
                        break;
                    case 4:
                        cell.setCellValue("CJ4");
                        break;
                    case 5:
                        cell.setCellValue("CJ5");
                        break;
                }
                // 添加内容至单元格
            }
               ...
               // 新建第rowNum行
                ...
                for (colNum = 0; colNum < 6; colNum++) {
                    ...
                    if(colNum==0){
                        switch (rowNum-1){
                            case 0:
                                cell.setCellValue("20-29岁");
                                break;
                            case 1:
                                cell.setCellValue("30-39岁");
                                break;
                            case 2:
                                cell.setCellValue("40-49岁");
                                break;
                            case 3:
                                cell.setCellValue("50-59岁");
                                break;
                            case 4:
                                cell.setCellValue("60岁以上");
                                break;
                        }
                    }else {
// 在当前行的colNum位置创建单元格
